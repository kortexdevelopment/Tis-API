<?php
	...
	{
		require_once $_SERVER["DOCUMENT_ROOT"] . "/system/functions/list_clients_filter.php";
	}
	else
	{
		require_once $_SERVER["DOCUMENT_ROOT"] . "/system/functions/list_clients.php";
	}
...
<html>
	...
	<script>
		...
		function ChangeType(clientType)
		{
			...
			switch(clientType)
			{
				case 0:
					...
					//alert("1"); // Here the client is individual
					break;
				case 1:
					...
					document.getElementById("clientForm").action = "/system/functions/create_client.php?type=" + <?php echo $clientTypeRegistration; ?>;
					//alert("2"); //Here the client is corp-llc
					break;
			}
		}
		...
		function SameAddres()
		{
			var cB = document.getElementById("chkAdd");
		...
		<div id="newClient" class="w3-modal w3-animate-opacity">
			<div class="w3-modal-content w3-small">
				...
				<form id="clientForm" class="w3-container" action="/system/functions/create_client.php?type=<?php echo $clientTypeRegistration; ?>" method="post">
					...
					<div class="w3-row-padding">
						<div class="w3-half">
							<input id="gA" class="w3-input w3-border" name="garage_address" type="text" placeholder="Garage Address" required>
						</div>
						<div class="w3-half">
							<input id="gC" class="w3-input w3-border" name="garage_city" type="text" placeholder="Garage City" required>
						</div>
					</div>

					<div class="w3-row-padding">
						<div class="w3-half">
							<input id="gS" class="w3-input w3-border" name="garage_state" type="text" placeholder="Garage State" required>
						</div>
						<div class="w3-half">
							<input id="gZ" class="w3-input w3-border" name="garage_zip" type="text" placeholder="Garage ZIP" required>
						</div>
					</div>
					...
					<input id="chkAdd" type="checkbox" onchange="SameAddres()"> 
					<label for="chkAdd"> Same as Garage </label>
					<div class="w3-row-padding">
						<div class="w3-half">
							<input id="mA" class="w3-input w3-border" name="mail_address" type="text" placeholder="Mail Address" required>
						</div>
						<div class="w3-half">
							<input id="mC" class="w3-input w3-border" name="mail_city" type="text" placeholder="Mail City" required>
						</div>
					</div>

					<div class="w3-row-padding">
						<div class="w3-half">
							<input id="mS" class="w3-input w3-border" name="mail_state" type="text" placeholder="Mail State" required>
						</div>
						<div class="w3-half">
							<input id="mZ" class="w3-input w3-border" name="mail_zip" type="text" placeholder="Mail ZIP" required>
						</div>
					</div>
			...
			<div class="w3-row">
				...
				<div class="w3-row">
					<form class="w3-container w3-half"> 
						<input class="w3-input w3-border w3-twothird" type="text" name="filter" placeholder="Enter search...">
						<input class="w3-button w3-round-xxlarge w3-blue-gray w3-third" type="submit" value="SEARCH">
					</form>
					<a href="/system/clients.php" class="w3-button w3-round-xxlarge w3-blue-gray w3-col m2">CLEAR SEARCH</a>
				</div>
				<br>
				<!-- Table goes here -->
