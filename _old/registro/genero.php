	...
	<body>
        ...
        <div class="w3-container w3-border">
            ...
            <header class="w3-center">
                <h2>REGISTAR NUEVO GENERO</h2>
            </header>

            <form action="/db/nuevogenero.php" method="post">
                <input type="text" name="genero" placeholder="Ingrese nombre del Genero" class="w3-threequarter w3-input w3-border">
