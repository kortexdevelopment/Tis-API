	...
	<body>
        ...
        <div class="w3-container w3-border">
            ...
            <header class="w3-center">
                <h2>REGISTAR NUEVA PRODUCTORA</h2>
            </header>

            <form action="/db/nuevaproductora.php" method="post">
                <input type="text" name="productora" placeholder="Ingrese nombre de la Productora" class="w3-threequarter w3-input w3-border">
