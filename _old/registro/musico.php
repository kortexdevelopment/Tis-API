	...
	<body>
        ...
        <div class="w3-container w3-border">
            ...
            <header class="w3-center">
                <h2>REGISTAR NUEVO MUSICO</h2>
            </header>

            <form action="/db/nuevomusico.php" method="post">
                <input type="text" name="musico" placeholder="Ingrese nombre del Musico" class="w3-threequarter w3-input w3-border">
