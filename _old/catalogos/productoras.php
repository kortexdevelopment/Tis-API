<?php
    ...
    require_once $_SERVER["DOCUMENT_ROOT"] . "/db/catalogoproductoras.php";
        ...
        <div class="w3-container w3-border">
            ...
            <table class="w3-table w3-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="/catalogos/juegosproductora.php?id=<?php echo $catalogo[$rows][0]; ?>">Ver</a>
                    </td>
