	...
	<body>
		...
		<div class="w3-container">
			<header class="w3-blue-gray w3-center">
				<h2>WELLCOME <b><?php echo $_SESSION["user_name"]?></b></h2>
			</header>
			...
			<div class="w3-row">
				...
				<div class="w3-col w3-container s4 m4 l4">
					<div class="w3-card-4 w3-border w3-center">
						...
						<br>
						<br>
						<a href="/system/clients_docs.php" class="w3-center"><button class="w3-button w3-blue-gray w3-round-xxlarge">GO TO DOCUMENTS</button></a>
						<br>
						<br>
					</div>
				</div>
