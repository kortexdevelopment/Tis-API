			...
			<form class="w3-card-4" action="/system/functions/<?php echo $client_data_extra[0] != null ? "update" : "create"?>_client_extra_data.php?client_id=<?php echo $client_id; ?><?php echo $client_data_extra[0] != null ? "&id=".$client_data_extra[0] : ""?>" autocomplete="off" method="post">
				...
				<div class="w3-row-padding">
					<div class="w3-half">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="bsn_year" placeholder="Enter data" value="<?php echo $client_data_extra[2]; ?>"  required>
					</div>
					<div class="w3-half">
						<label class="w3-text-blue-gray">Year Bussines Started</label>
						<input class=" w3-input w3-border-bottom" type="text" name="bsn_start" placeholder="Enter data" value="<?php echo $client_data_extra[3]; ?>" required >
					</div>
				</div>
				<br>
				<div class="w3-row-padding">
					<div class="w3-rest">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="commodity_a" placeholder="Enter data" value="<?php echo $client_data_extra[5]; ?>"  required>
					</div>
				</div>
				...
				<div class="w3-row-padding">
					<div class="w3-half">
						...
						<input class="w3-input w3-border-bottom" type="text" name="value_average_a" placeholder="Enter data" value="<?php echo $client_data_extra[17]; ?>"  required>
					</div>
					<div class="w3-half">
						<label class="w3-text-blue-gray">Max Value</label>
						<input class="w3-input w3-border-bottom" type="text" name="value_max_a" placeholder="Enter data" value="<?php echo $client_data_extra[19]; ?>"  required>
					</div>
				</div>
				<br>
				...
				<div class="w3-row-padding">
					<div class="w3-rest">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="commodity_b" placeholder="Enter data" value="<?php echo $client_data_extra[6]; ?>"  required>
					</div>
				</div>
				<div class="w3-row-padding">
					<div class="w3-half">
						<label class="w3-text-blue-gray">Average Value</label>
						<input class="w3-input w3-border-bottom" type="text" name="value_average_b" placeholder="Enter data" value="<?php echo $client_data_extra[18]; ?>"  required>
					</div>
					<div class="w3-half">
						<label class="w3-text-blue-gray">Max Value</label>
						<input class="w3-input w3-border-bottom" type="text" name="value_max_b" placeholder="Enter data" value="<?php echo $client_data_extra[20]; ?>"  required>
					</div>
				</div>
				<br>
				<div class="w3-row-padding">
					<div class="w3-third">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="moving_violations" placeholder="Enter data" value="<?php echo $client_data_extra[7]; ?>"  required>
					</div>
					<div class="w3-third">
						<label class="w3-text-blue-gray">No. of Accidents</label>
						<input class=" w3-input w3-border-bottom" type="text" name="accidents" placeholder="Enter data" value="<?php echo $client_data_extra[8]; ?>"  required>
					</div>
					<div class="w3-third">
						<label class="w3-text-blue-gray">No. of Estimated Annual Miles</label>
						<input class=" w3-input w3-border-bottom" type="text" name="anual_miles" placeholder="Enter data" value="<?php echo $client_data_extra[9]; ?>"  required>
					</div>
				</div>
				<br>
				<div class="w3-row-padding">
					<div class="w3-rest">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="prior_carrier" placeholder="Enter data" value="<?php echo $client_data_extra[4]; ?>"  required>
					</div>
				</div>
				<br>
				...
				<div class="w3-row-padding">
					<div class="w3-half">
						...
						<input class="w3-input w3-border-bottom" type="text" name="policy" placeholder="Enter data" value="<?php echo $client_data_extra[12]; ?>"  required>
					</div>
					<div class="w3-half">
						<label class="w3-text-blue-gray">Coverage Type</label>
						<input class="w3-input w3-border-bottom" type="text" name="coverage_type" placeholder="Enter data" value="<?php echo $client_data_extra[13]; ?>"  required>
					</div>
				</div>
				<br>
				...
				<div class="w3-row-padding">
					<div class="w3-third">
						...
						<input class=" w3-input w3-border-bottom" type="text" name="losses" placeholder="Enter data" value="<?php echo $client_data_extra[14]; ?>"  required>
					</div>
					<div class="w3-third">
						<label class="w3-text-blue-gray">Loss Amount</label>
						<input class=" w3-input w3-border-bottom" type="text" name="loss_amount" placeholder="Enter data" value="<?php echo $client_data_extra[15]; ?>"  required>
					</div>
					<div class="w3-third">
						<label class="w3-text-blue-gray">Driver Involved</label>
						<input class=" w3-input w3-border-bottom" type="text" name="loss_drivers" placeholder="Enter data" value="<?php echo $client_data_extra[16]; ?>"  required>
					</div>
				</div>
