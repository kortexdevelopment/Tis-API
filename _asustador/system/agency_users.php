<?php
    ...
    require_once $_SERVER["DOCUMENT_ROOT"] . "/system/functions/agency_users.php";
?>
...
<html>
	...
	<body>
		...
		<div id="navBar" class="w3-bar w3-border w3-blue-gray w3-padding-small">
			...
			<a href="/system/agency_profile.php" class="w3-bar-item w3-button w3-border-right">RETURN TO PROFILE</a>
		...
		<div id="list" class="w3-container">
            ...
            <table class="w3-table w3-striped w3-small">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $_SESSION["user_type"] == 2 ? $users_data[$rows][4] : "*****"; ?>
                    </td>
