<?php
	...
	$sql = "INSERT INTO vehicles VALUES (0,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	
	if($stmt = $db_conn->prepare($sql))
	{
		$stmt->bind_param("isssssdddddddd", $client_id, $make, $year, $gvw, $model, $vin, $tractor_v, $tractor_d, $trailer_v, $trailer_d, $non_v, $non_d, $inter_v, $inter_d);
