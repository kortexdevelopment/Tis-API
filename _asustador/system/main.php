			...
			<div class="w3-row w3-padding">
				...
				<div class="w3-col w3-container s3 m3 l3">
					<div class="w3-card-4 w3-border w3-center">
						...
						<br>
						<br>
						<a href="/system/agency_profile.php" class="w3-center"><button class="w3-button w3-blue-gray w3-round-xxlarge">GO TO PROFILE</button></a>
						<br>
						<br>
					</div>
				</div>
				...
				<div class="w3-col w3-container s4 m4 l4">
					<div class="w3-card-4 w3-border w3-center">
						...
						<br>
						<br>
						<a href="/system/clients.php" class="w3-center"><button class="w3-button w3-blue-gray w3-round-xxlarge">GO TO CLIENTS</button></a>
						<br>
						<br>
					</div>
				</div>
				...
				<div class="w3-col w3-container s3 m3 l3">
					<div class="w3-card-4 w3-border w3-center">
						<header class="w3-container w3-center w3-blue-gray">
							<h4>CLIENT REQUEST</h3>
						</header>
						<br>
						<i class="fa fa-book w3-jumbo" aria-hidden="true"></i>
						<br>
						<br>
						<a href="/system/client_request.php" class="w3-center"><button class="w3-button w3-blue-gray w3-round-xxlarge">GO TO REQUEST</button></a>
						<br>
						<br>
					</div>
				</div>
